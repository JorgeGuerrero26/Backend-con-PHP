...
<input type="text" name="title" class="rounded border-gay-200 w-full mb-4" 
...
<input type="text" name="slug" class="rounded border-gay-200 w-full mb-4" 
value="{{old('slug',$post->slug)}}">

<label class="uppercase text-gray-700 text-xs">Contenido</label>
<span class="text-xs text-red-600">@error('body'){{$message}} @enderror</span>

<textarea name="body" rows="5" class="rounded border-gay-200 w-full mb-4">{{old('body',$post->body)}}</textarea>
